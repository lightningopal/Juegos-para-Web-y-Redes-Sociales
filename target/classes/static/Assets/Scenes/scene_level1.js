class Scene_Level1 extends Phaser.Scene {
    ...
    preload() {
        var that = this;
        // this.add.tileSprite(0, 0, 1920, 1080, "stars").setOrigin(0, 0)
        this.bg = this.add.tileSprite(0, 0, 1920, 1174.5, "level_2_bg").setOrigin(0, 0).setDepth(-5);
        this.bg.tileScaleX = scaleX;
        this.bg.tileScaleY = scaleY;
        this.bgDetails = this.add.tileSprite(0, 0, 1920, 1174.5, "level_2_bg_details").setOrigin(0, 0).setDepth(-3);
        this.bgDetails.tileScaleX = scaleX;
        this.bgDetails.tileScaleY = scaleY;
        this.bgMove = this.add.tileSprite(0, 0, 1920, 1174.5, "level_2_bg_move").setOrigin(0, 0).setDepth(-2);
        ...
        this.fgDetails = this.add.tileSprite(0, 0, 1920, 1174.5, "level_2_fg_details").setOrigin(0, 0).setDepth(3);
        this.fgDetails.tileScaleX = scaleX;
        this.fgDetails.tileScaleY = scaleY;
        this.fgMove = this.add.tileSprite(0, 0, 1920, 1174.5, "level_2_fg_move").setOrigin(0, 0).setDepth(4);
            ...
            case "B":
                ...
                switch (game.mPlayer.characterSel.type) {
                    ...
                    case "berserker":
                        ...
                        this.versus_characterA.setScale(1.2, 1.3);
                        break;
                }
        ...
        // Versus texts
        this.fight_text = this.add.image(959, 428, "versus_fight").setDepth(20);
        this.knock_out_text = this.add.image(960, 414.5, "versus_knock_out").setDepth(20);
